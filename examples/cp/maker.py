...
def ti_singlecrystal(
    ...
    taus_1 = interpolate.PiecewiseLinearInterpolate(
        list(Ts), [193.0, 145.0, 95.0, 70.0, 53.0, 45.0, 18.0, 16.0, 9.0]
    )
    taus_2 = interpolate.PiecewiseLinearInterpolate(
        list(Ts), [118.0, 85.0, 80.0, 65.0, 48.0, 38.0, 17.0, 13.0, 4.0]
    )
    taus_3 = interpolate.PiecewiseLinearInterpolate(
        list(Ts), [225.0, 205.0, 115.0, 90.0, 82.0, 57.0, 35.0, 20.0, 13.0]
    )
    taut_1 = interpolate.PiecewiseLinearInterpolate(
        list(Ts), [156.0, 110.0, 82.0, 65.0, 48.0, 38.0, 35.0, 32.0, 30.0]
    )
    taut_2 = interpolate.PiecewiseLinearInterpolate(
        list(Ts), [203.0, 170.0, 100.0, 100.0, 80.0, 60.0, 50.0, 42.0, 40.0]
    )
    """
    # Constant part of the strength for slip and twin
    taus_1 = interpolate.PiecewiseLinearInterpolate(
    ...
    """
    # Initial strength for slip and twin
    tau0 = np.array(
        [taus_1] * 3 + [taus_2] * 3 + [taus_3] * 6 + [taut_1] * 6 + [taut_2] * 6
    )
