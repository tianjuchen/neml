...
def Ti_singxtal(verbose = True, PTR = True, 
  ...
  C11_old = np.array([162400.0, 155100.0, 149500.0, 144200.0, 136800.0, 132200.0, 127600.0, 123100.0, 119600.0])
  C33_old = np.array([180700.0, 175300.0, 171500.0, 167800.0, 162700.0, 159300.0, 156000.0, 152900.0, 150400.0])
  C44_old = np.array([46700.0, 44400.0, 42400.0, 40300.0, 37000.0, 34800.0, 32600.0, 30700.0, 29100.0])
  C12_old = np.array([92000.0, 94300.0, 96100.0, 97300.0, 98500.0, 99100.0, 99300.0, 99600.0, 99600.0])
  C13_old = np.array([69000.0, 69500.0, 69200.0, 69100.0, 68800.0, 68800.0, 68800.0, 68800.0, 68800.0])
  
  C11 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], C11_old[-2:]).value(Ts))
  C33 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], C33_old[-2:]).value(Ts))
  C44 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], C44_old[-2:]).value(Ts))
  C12 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], C12_old[-2:]).value(Ts))
  C13 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], C13_old[-2:]).value(Ts))
  ...
  taut_1_old = np.array([200.0, 170.0, 160.0, 150.0, 120.0, 110.0, 100.0, 100.0, 100.0])
  taut_2_old = np.array([250.0, 240.0, 230.0, 210.0, 200.0, 190.0, 180.0, 180.0, 180.0])
  
  
  
  taus_1 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], taus_1_old[-2:]).value(Ts))
  taus_2 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], taus_2_old[-2:]).value(Ts))
  taus_3 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], taus_3_old[-2:]).value(Ts))
  taut_1 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], taut_1_old[-2:]).value(Ts))
  taut_2 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], taut_2_old[-2:]).value(Ts))
  ...
  mu_slip_old = np.array([35200.0, 30400.0, 26700.0, 23400.0, 19100.0, 16600.0, 14200.0, 11800.0, 10000.0])
  mu_twin_old = np.array([25000.46, 21591.31, 18963.42, 16619.62, 13565.60, 11789.99, 10085.41, 8381.28, 7102.78])
  
  mu_slip = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], mu_slip_old[-2:]).value(Ts))
  ...
  mu_twin = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], mu_twin_old[-2:]).value(Ts))

  mu = np.array([mu_slip]*12+[mu_twin]*12)

  k1 = np.array([1.0]*3+[0.25]*3+[5.0]*6) / (ut)

  k2_1_old = np.array([250.0, 280.0, 330.0, 450.0, 500.0, 600.0, 1020.0, 1200.0, 1400.0])
  k2_2_old = np.array([250.0, 280.0, 330.0, 450.0, 500.0, 600.0, 1020.0, 1200.0, 1400.0])
  k2_3_old = np.array([250.0, 280.0, 330.0, 450.0, 500.0, 600.0, 1020.0, 1200.0, 1400.0])
  
  k2_1 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], k2_1_old[-2:]).value(Ts))
  k2_2 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], k2_2_old[-2:]).value(Ts))
  k2_3 = interpolate.PiecewiseLinearInterpolate(
      list(Ts),
      extrapolate(Ts_old[-2:], k2_3_old[-2:]).value(Ts))
...
if __name__ == "__main__":
    ...
    C11 = np.array([162400.0, 155100.0, 149500.0, 144200.0, 136800.0, 132200.0, 127600.0, 123100.0, 119600.0])
    Ts_new = np.array([298.0, 423.0, 523.0, 623.0, 773.0, 873.0, 973.0, 1073.0, 1173.0, 1255.372])
