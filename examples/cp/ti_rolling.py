...
if __name__ == "__main__":
    ...
    tau0 = (
        np.array([170.0] * 3 + [90.5] * 3 + [210] * 6 + [180.0] * 6 + [250.0] * 6)
        / 10.0
    )
    ...
    orientations = np.concatenate((orientations_1, orientations_2, orientations_3))
    """
    ...
    data = pd.DataFrame(
        {
            ...
            "ori_2": updated_euler[:, 1],
            "ori_3": updated_euler[:, 2],
        }
    )
